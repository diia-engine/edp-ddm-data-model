...
USER liquibase
RUN curl -fsSL -o /liquibase/lib/liquibase-ddm-ext.jar https://nexus-public-mdtu-ddm-edp-cicd.apps.cicd2.mdtu-ddm.projects.epam.com/repository/edp-maven-snapshots/com/epam/digital/data/platform/liquibase-ddm-ext/1.4.0-SNAPSHOT/liquibase-ddm-ext-1.4.0-20210809.143811-1.jar
