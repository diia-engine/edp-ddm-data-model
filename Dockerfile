...
USER liquibase
RUN curl -fsSL -o /liquibase/lib/liquibase-ddm-ext.jar https://nexus-public-mdtu-ddm-edp-cicd.apps.cicd2.mdtu-ddm.projects.epam.com/repository/edp-maven-snapshots/org/liquibase/ext/liquibase-ddm-ext/1.4.0-SNAPSHOT/liquibase-ddm-ext-1.4.0-20210804.142228-1.jar
